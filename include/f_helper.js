	...
	elemParams.trident7 = navigator.userAgent.toLowerCase().indexOf("trident/7.0") != -1;
	elemParams.trident6 = navigator.userAgent.toLowerCase().indexOf("trident/6.0") != -1;	
	elemParams.dec_htmltitle = "";
    ...
    function ensureIE11HTMLTitle() {
        if ((elemParams.trident6 || elemParams.trident7) && !locParams.insWSC && !locParams.preview2 && typeof htmlTitle != "undefined" && elemParams.dec_htmltitle != htmlTitle) {
            elemParams.dec_htmltitle = elemParams.jdecode(htmlTitle);
            document.title = elemParams.dec_htmltitle;
        }
    }
